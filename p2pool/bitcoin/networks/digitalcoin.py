...
BLOCK_EXPLORER_URL_PREFIX = 'http://dgc.blockr.io/block/info/'
ADDRESS_EXPLORER_URL_PREFIX = 'http://dgc.blockr.io/address/info/'
TX_EXPLORER_URL_PREFIX = 'http://dgc.blockr.io/tx/info/'
