...
BLOCK_EXPLORER_URL_PREFIX = 'http://bitinfocharts.com/zetacoin/blockhash/'
ADDRESS_EXPLORER_URL_PREFIX = 'http://bitinfocharts.com/zetacoin/address/'
TX_EXPLORER_URL_PREFIX = 'http://bitinfocharts.com/zetacoin/tx/'
