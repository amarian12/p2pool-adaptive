...
PERSIST = False
WORKER_PORT = 9883
BOOTSTRAP_ADDRS = 'salomon.styx.net.pl p2pool-eu.gotgeeks.com p2pool-us.gotgeeks.com rav3n.dtdns.net p2pool.gotgeeks.com p2pool.dndns.net solidpool.org'.split(' ')
