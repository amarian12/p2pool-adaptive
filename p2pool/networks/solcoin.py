...
PERSIST = False
WORKER_PORT = 8360
BOOTSTRAP_ADDRS = 'p2pool.solcoin.net p2pool-eu.gotgeeks.com p2pool-us.gotgeeks.com rav3n.dtdns.net doge.dtdns.net pool.hostv.pl p2pool.org p2pool.gotgeeks.com p2pool.dtdns.net solidpool.org'.split(' ')
